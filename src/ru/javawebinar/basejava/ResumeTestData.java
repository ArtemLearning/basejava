...
public class ResumeTestData {
    ...
    public static void fillContactPhone(String phone) {
        resume.getContacts().put(ContactType.PHONE, phone);
    }
    ...
    public static void fillContactLinkHeader(String linkHeader) {
        resume.getContacts().put(ContactType.LINK_HEADER, linkHeader);
    }

    public static void fillContactLink(String link) {
        resume.getContacts().put(ContactType.LINK, link);
    }

    public static void fillSectionPersonal(AbstractSection personal) {
        resume.getSections().put(SectionType.PERSONAL, personal);
    }

    public static void fillSectionObjective(AbstractSection objective) {
        resume.getSections().put(SectionType.OBJECTIVE, objective);
    }

    public static void fillSectionAchievement(AbstractSection achievement) {
        resume.getSections().put(SectionType.ACHIEVEMENT, achievement);
    }

    public static void fillSectionQualifications(AbstractSection qualifications) {
        resume.getSections().put(SectionType.QUALIFICATIONS, qualifications);
    }

    public static void fillSectionExperience(AbstractSection experience) {
        resume.getSections().put(SectionType.EXPERIENCE, experience);
    }

    public static void fillSectionEducation(AbstractSection education) {
